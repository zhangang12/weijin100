...
const LISTINGS: Listing[] = [
  { listingId: 'L_88001', seller: { userMasked: 'j*****6', level: 'L9', shopName: '融通足金', deals: 128 }, metal: 'gold', category: '板料', goodsName: '融通足金价', tags: ['板料', '整出'], totalWeight: 1000, remainingWeight: 1000, shipMode: 'whole_all', refPriceCash: '1,032.21', refPriceTransfer: '1,033.21', supportTransfer: true },
  { listingId: 'L_88002', seller: { userMasked: 'k*****', level: 'L6', shopName: '融通足金', deals: 128 }, metal: 'gold', category: '板料', goodsName: '融通足金价', tags: ['板料', '散出', '现货'], totalWeight: 987, remainingWeight: 987, shipMode: 'bulk', minBatch: 1, refPriceCash: '1,031.80', refPriceTransfer: '1,032.80', supportTransfer: true },
  { listingId: 'L_88003', seller: { userMasked: 'l*****8', level: 'L9', shopName: '融通足金', deals: 128 }, metal: 'gold', category: '板料', goodsName: '融通足金价', tags: ['板料', '整出', '现货'], totalWeight: 1500, remainingWeight: 1500, shipMode: 'whole_fixed', lotSize: 500, refPriceCash: '1,032.21', refPriceTransfer: '1,033.21', supportTransfer: true },
  { listingId: 'L_88004', seller: { userMasked: 'm*****', level: 'L4', shopName: '融通足金', deals: 128 }, metal: 'gold', category: '旧料', goodsName: '融通足金价', tags: ['旧料', '散出', '现货'], totalWeight: 860, remainingWeight: 860, shipMode: 'bulk', minBatch: 50, refPriceCash: '1,030.50', refPriceTransfer: '1,031.50', supportTransfer: true },
  { listingId: 'L_88005', seller: { userMasked: 'n*****', level: 'L2', shopName: '融通足金', deals: 128 }, metal: 'gold', category: '板料', goodsName: '融通足金价', tags: ['板料', '散出'], totalWeight: 1200, remainingWeight: 1200, shipMode: 'bulk', minBatch: 100, refPriceCash: '1,031.00', refPriceTransfer: undefined, supportTransfer: false },
];
